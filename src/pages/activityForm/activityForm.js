 ...
 */
//@IonicPage()
var ActivityFormPage = (function () {
    function ActivityFormPage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    }
    ActivityFormPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad EventFormPage');
    };
    return ActivityFormPage;
}());
ActivityFormPage = __decorate([
    Component({
